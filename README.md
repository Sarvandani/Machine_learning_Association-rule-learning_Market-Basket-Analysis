# Machine_learning_Association-rule-learning_Market-Basket-Analysis
...
The number of customer per month, week, and day have been plotted to see the variations and the average number of customers.
